...
/**
 * permet de récuperer les données clients pour les afficher
 * Servlet implementation class ServletAfficherClient
 */
@WebServlet("/ServletAfficherClient2")
public class ServletAfficherClient2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletAfficherClient2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		dispatcher=request.getRequestDispatcher("afficherClient.jsp");
